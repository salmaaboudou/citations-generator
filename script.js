...
function randomValue(){
    let recupValue = allCitations[Math.floor(Math.random()*allCitations.length)]
...
function newCitation(){
    let randomCitation = randomValue()
    citation.innerHTML = randomCitation[0]
    author.innerHTML = randomCitation[1]
